...
def migrate():
    ...
    menuitems = [
        ...
        MenuItem(name="Ice Cream", description="2 scoops of vanilla ice cream,", calorie=300,
                 price=2.50,
                 menugroup=menugroups["dessert"], allergens=[]),
        # Soft Drinks
        ...
        MenuItem(name="Corona Extra", description="light, refreshing with wedge of lime",
                 calorie=300, price=3,
                 menugroup=menugroups["beer"], allergens=[]),
        ...
        MenuItem(name="Margarita",
                 description="classic cocktail featuring tequila, lime juice, and orange liqueur, "
        ...
        MenuItem(name="Michelada",
                 description="spicy and savory Mexican beer cocktail made with beer, lime juice, "
                             "assorted sauces, spices, and chili peppers, served over ice with a "
                             "salted rim",
                 calorie=140, price=11, menugroup=menugroups["cocktail"], allergens=[]),
        MenuItem(name="Tequila Sunrise",
                 description="made with tequila, orange juice, and grenadine, creating a gradient "
                             "of colors resembling a sunrise",
                 calorie=300, price=8, menugroup=menugroups["cocktail"], allergens=[]),
        MenuItem(name="Mexican Mule",
                 description="variation of the classic Moscow Mule cocktail, made with tequila, "
                             "lime juice, and ginger beer, served over ice with a wedge of lime",
