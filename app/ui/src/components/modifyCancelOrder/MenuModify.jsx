  ...
  return (
    <div className="Menu relative overflow-x-auto">
      {filterButtons.map((item, index) => (
        <button
          className="bg-redder text-black text-3xl  font-sans font-bold py-5 px-5 my-2 mx-1 space-x-4 rounded-lg"
          key={index}
          value={item.name}
        ...
        <tbody>
          {filteredMenu.map((item) => (
            ...
            >
              ...
              >
                <Modal.Header className="text-5xl text-black text-sans text-base">
                  {foodName}
                </Modal.Header>
                <Modal.Body>
                  <div className="space-y-6">
                    ...
                    {allergens &&
                      allergens.map((food) => (
                        <p
                          key={food.id}
                          className="text-m text-black text-sans text-base"
                        >
                          Allergen: {food.name}
                        </p>
                      ))}
