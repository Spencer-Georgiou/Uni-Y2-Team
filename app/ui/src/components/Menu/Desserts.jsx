    ...
    return (
        <div class="bg-lemon border-gray-200 dark:bg-gray-900">
            <div class="flex flex-wrap justify-between mx-auto w-full h-128 px-7">
                <img src="/menu/desserts.png" alt="picture" class="w-1/2 h-20 ml-80 mt-7" />
                            ...
                            <tbody>
                                <tr class="bg-juice">
                                    <th scope="row" class="px-6 h-5 font-medium text-lemon">
                                        <b> Churros</b>
                                        <p class="text-gray-900">Fried churros with a chocolate filling(Vg)</p>
                                    </th>
                                ...
                                <tr class="bg-juice">
                                    <th scope="row" class="px-6 h-5 font-medium text-lemon">
                                        <b>Ice cream</b>
                                        <p class="text-gray-900">2 scoops of ice cream, choose between: (Vg)</p>
