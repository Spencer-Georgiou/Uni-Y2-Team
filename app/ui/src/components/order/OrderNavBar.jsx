...
function OrderNavBar() {
  return (
    <Navbar className="bg-cherry fixed t-0 z-20 w-full">
      ...
      <div className="flex gap-2 md:order-2 ">
        <Dropdown
          label={
            <span className="font-sans font-semibold text-lemon border-lemon">
              Log in
            </span>
          }
          dismissOnClick={false}
        >
          <Dropdown.Item as={Link} to="/StaffLogin" className="focus:bg-amber">
            Staff Login
          </Dropdown.Item>
          <Dropdown.Item
            as={Link}
            to="/CustomerLogin"
            className="focus:bg-amber"
          >
            Customer Login
          </Dropdown.Item>
        </Dropdown>
