...
const Payment = ({ openPay, setOpenPay, setOpenModal }) => {
  ...
  return (
    <>
      ...
      <Modal show={openPay} size="xl" onClose={() => setOpenPay(false)}>
        <Modal.Header className="ml-3">Pay Online</Modal.Header>
        <Modal.Body>
          <form class="max-w-sm mx-auto" onSubmit={handleSubmit}>
            ...
            <div className="my-1">
              <p className="float-left text-sm text-cherry mr-4">
                Pay by cash?
              </p>
              <p className="text-sm underline hover:text-cherry ">
                Call Waiter
              </p>
            </div>
          </form>
