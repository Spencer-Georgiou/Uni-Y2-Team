          ...
          order.map((o, index) => (
            <Fragment key={index}>
              ...
              <span>
                ...
                <button
                  type="button"
                  className="ml-48 border text-gray-800 border-gray-800 bg-amber hover:bg-white focus:ring-4 focus:outline-none font-medium rounded-full text-sm px-1.5 py-1.5 text-center inline-flex items-center m-1 hover:text-dark hover:bg-amber"
                >
                  <svg
