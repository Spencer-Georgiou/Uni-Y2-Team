    ...
    return(
        <div>
            <div
                ...
                <div className="flex flex-row space-x-4 m-auto flex justify-center">

                    

                    <div className="bg-lemon rounded-[25px] m-auto bg-opacity-85 relative flex justify-center">
                        <div>
                    ...
                    <div className="flex flex-col relative justify-center bg-lemon rounded-[25px] py-5 m-auto opacity-95">
                        <div className="flex relative block group items-center justify-center">
